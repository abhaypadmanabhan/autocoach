...
const itemBase =
  "relative flex cursor-pointer select-none items-center gap-2 rounded-sm px-2 py-1.5 text-[13px] text-[var(--fg-secondary)] outline-none transition-colors hover:text-[var(--fg-primary)] focus:bg-[var(--bg-surface)] focus:text-[var(--fg-primary)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:size-3.5 [&_svg]:shrink-0";
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(itemBase, "data-[state=open]:bg-[var(--bg-surface)]", inset && "pl-8", className)}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--fg-tertiary)]",
      inset && "pl-8",
      className,
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto font-mono text-[10.5px] uppercase tracking-[0.08em] text-[var(--fg-tertiary)]",
      className,
    )}
    {...props}
  />
