...
export function SmartReviewCard() {
  ...
  if (error) {
    return (
      <div className="border border-[var(--danger)] bg-transparent p-5 flex items-start gap-3">
    ...
    return (
      <div className="rounded-md border border-[var(--line-subtle)] bg-[var(--bg-base)] p-5">
        <div className="flex items-start gap-3">
          <div className="grid place-items-center h-9 w-9 bg-[var(--bg-elev)] border border-[var(--line-subtle)]">
